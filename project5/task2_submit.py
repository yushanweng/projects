...
inputFilePath = '../../PycharmProjects/553hw4/ub_sample_data.csv'
#input_file_path = sys.argv[2]
textRDD = sc.textFile(inputFilePath).persist()

outputFilePathB = '../../PycharmProjects/553hw4/task2_1_ans.txt'
#output_file_path = sys.argv[3]

outputFilePathC= '../../PycharmProjects/553hw4/task2_2_ans.txt'
